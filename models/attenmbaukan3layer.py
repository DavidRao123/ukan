...
class KANLayer(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0., no_kan=False):
        ...
        if not no_kan:
            ...
            self.fc2 = AttentionKANLinear(hidden_features, hidden_features, degree=3)
            self.fc3 = AttentionKANLinear(hidden_features, out_features, degree=3)
            # # TODO
            # self.fc4 = KANLinear(
            #             hidden_features,
            #             out_features,
...
class AttenMSA_UKAN3(nn.Module):
    def __init__(self, in_channels, norm_layer=nn.LayerNorm, img_size = 512, embed_dims=[256, 320, 512]
        ...
        self.att_cab = KANCAB(embed_dims[2])
